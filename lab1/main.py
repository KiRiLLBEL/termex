...
VLine, = ax1.plot([X[0], X[0]+VX[0]], [Y[0], Y[0]+VY[0]], 'green', label='Вектор скорости')
WLine, = ax1.plot([X[0], X[0]+WX[0]], [Y[0], Y[0]+WY[0]], 'red', label='Вектор ускорения')
...
VArrow, = ax1.plot(RArrowX + X[0] + VX[0], RArrowY + Y[0] + VY[0], 'green')
WArrow, = ax1.plot(WRArrowX + X[0] + WX[0], WRArrowY + Y[0] + WY[0], 'red')
